...
import { Reveal, SectionProgress } from "./MotionPrimitives";

const steps = [
  {
    n: "01",
    t: "Brief & goals",
    d: "Understanding the business, audience, problems and where the project really needs to land.",
  },
  {
    n: "02",
    t: "Research & structure",
    d: "Competitors, journeys, content architecture — defining what the system has to do.",
  },
  {
    n: "03",
    t: "Concept & design",
    d: "Wireframes, visual direction and interfaces built around clarity and business goals.",
  },
  {
    n: "04",
    t: "System logic",
    d: "Connecting the design to CRM, email, forms, payments — the plumbing nobody sees.",
  },
  {
    n: "05",
    t: "Build & review",
    d: "Final design, testing the flow, collecting feedback and tuning every detail.",
  },
  {
    n: "06",
    t: "Launch & support",
    d: "Helping the project ship — then iterating with analytics and continued improvements.",
  },
];
    ...
    >
        ...
        <Reveal className="col-span-12 md:col-span-10">
          <h2 className="font-display uppercase text-6xl md:text-9xl leading-[0.9]">
            ...
            <span className="text-outline">
              to shipped<span className="text-acid">.</span>
            </span>
          </h2>
        </Reveal>
      </div>
      ...
      <ul className="mx-auto max-w-[1700px] px-6 md:px-10 border-t border-border">
        {steps.map((s, i) => (
          ...
          >
            <SectionProgress className="col-span-12 -mt-8" />
            ...
            <p className="col-span-12 md:col-span-7 text-cream/75 text-balance md:text-lg">{s.d}</p>
          </motion.li>
        ))}
      </ul>
