  ...
  head: () => ({
    meta: [
      ...
      { property: "og:image:height", content: "630" },
      {
        ...
        content: "Polina Alekseeva portfolio preview with designer of digital systems headline.",
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Archivo:wght@400;500;700;900&family=Archivo+Black&family=Space+Grotesk:wght@300;400;500;600&family=Geist+Mono:wght@400;500&family=Instrument+Serif:ital@0;1&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
